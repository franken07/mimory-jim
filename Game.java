        ...
        public class Game extends JFrame {
            ...
            public void win() {
                try {
                    ...
                    // Open the audio input stream using the clip
             ...
             public void bgsound() {
                try {
                    ...
                    AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("bg sound.wav"));
                    Clip clip = AudioSystem.getClip();
                    clip.open(audioInputStream);
                    clip.start();
                    bgClip = clip;
            ...
            public void pair() {
                try {
                    ...
                    AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("pair.wav"));
                    Clip clip = AudioSystem.getClip();
                    clip.open(audioInputStream);
                    clip.start();
